...
public class CategoriaUsuarioService {
    ...
    public Optional<CategoriaUsuario> getById(Long idCatUsu) {
        return categoriaUsuarioRepository.findById(idCatUsu);
    }

    public CategoriaUsuario updateJornada(CategoriaUsuario categoriaUsuario){
        return categoriaUsuarioRepository.save(categoriaUsuario);
    }

    public void deleteJornada(Long idCatUsu) {
        categoriaUsuarioRepository.deleteById(idCatUsu);
    }
}
